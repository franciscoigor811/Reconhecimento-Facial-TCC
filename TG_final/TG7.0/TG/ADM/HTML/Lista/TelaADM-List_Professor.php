...
<body>
    ...
    <main>
        ...
        <h2 class="diferencialTabela"> Professores Ativos</h2>
        <table>
            <thead>
                <tr>
                    <th>Nome</th>
            ...
            <?php
                $banco = new Banco();
                $stmt = $banco->getConexao()->prepare("SELECT `RA`,`Nome`,`Email` FROM `professor` where ativo = 1");
        ...
        while ($linha = $result->fetch_object()) {
            ...
            echo '<td><a href="../Editar/TelaADM-Edit_Professor.php?ra='.$linha->RA.'">Editar</a></td>';
            ...
            echo '</tr>';
                ...
                <!-- <tr>
                    ...
                    <td>123456</td>
                    <td>
                        <a href="../Editar/TelaADM-Edit_Professor.php">Editar</a>
                    </td>
                </tr>
                <tr>
                    <td>João Silva</td>
        ...
        <h2 class="diferencialTabela"> Professores Inativos</h2>
        <table>
            <thead>
                <tr>
                    <th>Nome</th>
            ...
            <?php
                $banco = new Banco();
                $stmt = $banco->getConexao()->prepare("SELECT `RA`,`Nome`,`Email` FROM `professor` where ativo = 0");
