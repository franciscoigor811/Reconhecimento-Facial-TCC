...
<body>
    ...
    <main>
        <form action="Update_aluno.php" method="post">
            <?php
            $banco = new Banco();
            $stmt = $banco->getConexao()->prepare("SELECT * FROM `aluno` where RA = ?");
            ...
            while ($linha = $result->fetch_object()) {
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nomeAluno" name="nomeAluno" required value="<?php echo $linha->Nome; ?>">
                </div>
                <div class="form-group">
                    <label for="email">Email:</label>
                    <input type="email" id="emailAluno" name="emailAluno" required value="<?php echo $linha->Email; ?>">
                </div>
                <div class="form-group">
                    <label for="estado">Estado:</label>
                    <input type="text" id="estadoAluno" name="estadoAluno" required value="<?php echo $linha->Estado; ?>">
                </div>
                <div class="form-group">
                    <label for="cidade">Cidade:</label>
                    <input type="text" id="cidadeAluno" name="cidadeAluno" required value="<?php echo $linha->Cidade; ?>">
                </div>
                <div class="form-group">
                    <label for="bairro">Bairro:</label>
                    <input type="text" id="bairroAluno" name="bairroAluno" required value="<?php echo $linha->Bairro; ?>">
                </div>
                <div class="form-group">
                    <label for="rua">Rua:</label>
                    <input type="text" id="ruaAluno" name="ruaAluno" required value="<?php echo $linha->Rua; ?>">
                </div>
                <div class="form-group">
                    <label for="cep">CEP:</label>
                    <input type="text" id="cepAluno" name="cepAluno" required value="<?php echo $linha->CEP; ?>">
                </div>
                <div class="form-group">
                    <label for="RA">RA:</label>
                    <input type="text" id="RA" inputmode="numeric" pattern="[0-9]*" readonly
                ...
                <a href="../Lista/TelaADM-List_Aluno.php"><button type="button">Voltar</button></a>
                <?php
            }
            ?>
        </form>
